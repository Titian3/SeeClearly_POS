...
namespace SeeClearlyPOS_Console
{
    class TerminalConsole
    {
        static void Main(string[] args)
        {
            ...
            TerminalPOS newTerminalSession = new TerminalPOS();
            TerminalPOS.Cart shoppingCart = new TerminalPOS.Cart();
            TerminalPOS.Catalog priceCatalog = new TerminalPOS.Catalog();
